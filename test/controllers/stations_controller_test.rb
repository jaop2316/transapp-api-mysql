...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { codParada: @station.codParada, latParada: @station.latParada, lonParada: @station.lonParada, nomParada: @station.nomParada, route_id: @station.route_id } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { codParada: @station.codParada, latParada: @station.latParada, lonParada: @station.lonParada, nomParada: @station.nomParada, route_id: @station.route_id } }
